 ...
 */
public class App implements RequestHandler<Object, Object>, InvokeUrl {
    ...
    public Object handleRequest(final Object input, final Context context) {
        ...
        try {
            ...
            return new GatewayResponse(response, headers, UtilityConstants.SUCCESS_STATUS);
        } catch (IOException e) {
